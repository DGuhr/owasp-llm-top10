            ...
            <div className="text-innoq-gray p-8">
                <div className="max-w-4xl mx-auto space-y-8">
                    ...
                    <div className="bg-[#f7f7f7] border border-innoq-gray-25 rounded-lg p-6">
                        <h2 className="text-xl font-semibold text-innoq-green mb-4">Understanding Data Poisoning</h2>

                        <div className="space-y-6">
                            <div>
                                <h3 className="text-lg font-medium text-innoq-green mb-2">What is Data Poisoning?</h3>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    <h3 className="text-lg font-medium text-innoq-green mb-2">Attack Vectors</h3>
                                    <ul className="list-disc list-inside space-y-2 text-innoq-gray-75">
                                        <li><span className="text-innoq-green">Training Data:</span> Injecting harmful content</li>
                                        <li><span className="text-innoq-green">Fine-tuning:</span> Manipulating model adaptation</li>
                                        <li><span className="text-innoq-green">Embeddings:</span> Corrupting vector representations</li>
                                        <li><span className="text-innoq-green">Backdoors:</span> Implementing hidden triggers</li>
                                    </ul>
                                </div>

                                <div>
                                    <h3 className="text-lg font-medium text-innoq-green mb-2">Warning Signs</h3>
                                    <ul className="list-disc list-inside space-y-2 text-innoq-gray-75">
                    ...
                    <div className="bg-[#f7f7f7] rounded-lg p-6 space-y-6">
                        <h2 className="text-xl font-semibold flex items-center gap-2">
                            <BarChart2 className="w-6 h-6 text-innoq-green" />
                            ...
                            {datasets.map((dataset) => (
                                <div
                                    ...
                                    className={`p-4 rounded-lg cursor-pointer transition-colors ${selectedDataset === dataset.id
                                        ...
                                        } border ${selectedDataset === dataset.id ? 'border-innoq-green' : 'border-innoq-gray-25'
                                        }`}
                                >
                                    <div className="flex justify-between items-start mb-2">
                                        <h3 className="font-medium text-innoq-green">{dataset.name}</h3>
                                        {dataset.warning && (
                                            <FileWarning className="w-4 h-4 text-innoq-apricot" />
                                        )}
                                    </div>
                                    <p className="text-sm text-innoq-gray-75 mb-2">{dataset.description}</p>
                                    <div className="flex justify-between text-xs text-innoq-gray-75">
                                        <span>{dataset.size}</span>
                                        <span>{dataset.source}</span>
                                    </div>
                                    {dataset.warning && (
                                        <p className="text-xs text-innoq-apricot mt-2">{dataset.warning}</p>
                                    )}
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="flex gap-4 items-center">
                            <button
                                ...
                                className="px-4 py-2 hover:opacity-90 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 text-white"
                        ...
                        {success && (
                            <div className="flex items-start gap-2 text-innoq-green bg-innoq-green/10 p-4 rounded-lg">
                                <Shield className="w-5 h-5 mt-0.5" />
                                <div>
                                    <p className="font-medium">{success}</p>
                                    <p className="text-sm text-innoq-green mt-1">
                        ...
                        {poisonedExamples && poisonedExamples.length > 0 && (
                            <div className="bg-white border border-innoq-apricot/20 rounded-lg p-6 space-y-4">
                                <h3 className="text-lg font-medium flex items-center gap-2">
                                    <FileWarning className="w-5 h-5 text-innoq-apricot" />
                                    Detected Poisoned Data Examples
                                </h3>
                                <div className="grid gap-4">
                                    {poisonedExamples.map((example, index) => (
                                        <div key={index} className="bg-[#f7f7f7] p-4 rounded-lg space-y-3 border border-innoq-gray-25">
                                            <div className="flex justify-between items-start">
                                                <h4 className="text-sm font-medium text-innoq-green">
                                                    Example {index + 1}
                                                </h4>
                                                <span className="text-xs text-innoq-apricot bg-innoq-apricot/10 px-2 py-1 rounded">
                                                    {example.type}
                                                </span>
                                            </div>
                                            <div className="grid gap-2">
                                                <div>
                                                    <p className="text-xs text-innoq-gray-75 mb-1">Original Data:</p>
                                                    <p className="text-sm text-innoq-gray-75 bg-[#f7f7f7] p-3 rounded">
                                                        {example.original}
                                                    </p>
                                                </div>
                                                <div>
                                                    <p className="text-xs text-innoq-gray-75 mb-1">Poisoned Version:</p>
                                                    <p className="text-sm text-innoq-red bg-innoq-red/10 p-3 rounded border border-innoq-red/20">
                                                        {example.poisoned}
                                                    </p>
                                                </div>
                                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    <div className="bg-white p-4 rounded-lg">
                                        <p className="text-sm text-innoq-gray-75 mb-1">Accuracy</p>
                                    ...
                                    <div className="bg-white p-4 rounded-lg">
                                        <p className="text-sm text-innoq-gray-75 mb-1">Bias Score</p>
                                        <div className="flex items-end gap-1">
                                            <span className="text-2xl font-medium">
                                                {modelMetrics.bias}
                                            </span>
                                            <span className="text-sm text-innoq-gray-75 mb-1">/10</span>
                                        </div>
                                    </div>
                                    <div className="bg-white p-4 rounded-lg">
                                        <p className="text-sm text-innoq-gray-75 mb-1">Toxicity Level</p>
                                        <div className="flex items-end gap-1">
                                            <span className="text-2xl font-medium">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="bg-white p-4 rounded-lg space-y-1">
                                    {trainingLogs.map((log, index) => (
                                        <p key={index} className="font-mono text-sm text-innoq-gray-75">
                                            {log}
                                        </p>
                                    ))}
                                </div>
                    ...
                    <div className="bg-[#f7f7f7] rounded-lg p-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div>
                                <h3 className="text-innoq-green font-medium mb-2">Data Validation</h3>
                            ...
                            <div>
                                <h3 className="text-innoq-green font-medium mb-2">Security Controls</h3>
                                <ul className="list-disc list-inside space-y-1 text-innoq-gray-75 text-sm">
