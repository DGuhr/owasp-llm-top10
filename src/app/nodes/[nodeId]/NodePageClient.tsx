                ...
                <div className="max-w-7xl mx-auto space-y-8">
                    ...
                    <TerminalSection title="Related Vulnerabilities" accentColor={ACCENT_COLOR}>
                        {relatedVulnerabilities.length > 0 ? (
                            ...
                            <div className="bg-[#f7f7f7] border-2 rounded-lg p-6 text-center" style={{ borderColor: `${ACCENT_COLOR}33` }}>
                                <p className="text-innoq-gray-75">No specific vulnerabilities found for this component.</p>
                            </div>
                        )}
                    </TerminalSection>
                </div>
