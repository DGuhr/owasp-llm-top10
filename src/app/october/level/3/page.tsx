          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <span className="text-sm text-innoq-gray-75">Level 3</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* Phase Switcher */}
              <div className="flex gap-2 bg-[#f7f7f7] border border-orange-900/30 rounded-lg p-2">
                <button
                  onClick={() => setCurrentPhase('composer')}
                  className={`flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg font-medium transition-all ${
                    currentPhase === 'composer'
                      ? 'bg-gradient-to-r from-orange-600 to-orange-500 text-white shadow-lg'
                      : 'text-innoq-gray-75 hover:text-orange-400'
                  }`}
                >
              ...
              {emailSentNotification && (
                <div className="bg-innoq-green/10 border border-innoq-green/40 rounded-lg p-4 animate-pulse">
                  ...
                  <div className="relative bg-gradient-to-r from-gray-900 via-orange-950/30 to-gray-900 px-6 py-4 border-b-2 border-orange-900/40">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-innoq-gray-75">victim@company.com</div>
                      </div>
