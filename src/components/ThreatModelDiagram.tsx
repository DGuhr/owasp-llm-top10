...
const nodes: Node[] = [
    { id: 'client', type: 'entity', label: 'Client/Malicious Actor', icon: Globe, color: '#004153', size: 55 },
    { id: 'inference', type: 'service', label: 'Ingress', icon: Bot, color: '#24244c', size: 50 },
    { id: 'llm_service', type: 'service', label: 'LLM Service', icon: Server, color: '#ff9c66', size: 60 },
    { id: 'vector_db', type: 'storage', label: 'Vector DB', icon: Database, color: '#55cdaf', size: 50 },
    { id: 'training', type: 'service', label: 'Training Pipeline', icon: Code, color: '#fff019', size: 50 },
    { id: 'security', type: 'service', label: 'Security Layer', icon: Shield, color: '#ff4d67', size: 40 }
]
...
export function ThreatModelDiagram({ onVulnerabilityClick }: ThreatModelProps) {
    ...
    return (
        <div className="w-full aspect-[16/9] bg-white rounded-lg border border-innoq-petrol/20 relative p-4">
            {/* Background grid pattern */}
            <div className="absolute inset-0 opacity-10 rounded-lg overflow-hidden">
                <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse">
                            <path d="M 40 0 L 0 0 0 40" fill="none" stroke="#004153" strokeWidth="0.5"/>
                        </pattern>
                    </defs>
                        ...
                        return (
                            <g key={`${edge.from}-${edge.to}`}>
                                ...
                                <path
                                    ...
                                    stroke={isHighlighted ? 'url(#connection-gradient)' : 'rgba(0, 65, 83, 0.2)'}
                            ...
                            >
                                ...
                                >
                                    <div style={{
                                        ...
                                        <p className="text-xs text-innoq-gray-75 leading-relaxed">
                                            {vuln.description}
                                        </p>
                                    </div>
                                </foreignObject>
